...
import { Calendar, AlertCircle, CheckCircle, XCircle, CreditCard } from 'lucide-react'
...
export default function StatisticsCards({
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
      ...
      <div className="group relative overflow-hidden bg-gradient-to-br from-orange-400 to-orange-500 rounded-[15px] shadow-drop hover:shadow-drop-lg transition-all duration-300 transform hover:-translate-y-1 animate-slideUp" style={{ animationDelay: '0.25s' }}>
        <div className="absolute top-0 right-0 w-24 h-24 bg-white opacity-10 rounded-full -mr-12 -mt-12"></div>
        <div className="p-5 text-white relative">
          <div className="flex items-center justify-between mb-3">
            <div className="p-2.5 bg-white bg-opacity-20 rounded-[8px] backdrop-blur-sm">
          ...
          <div className="text-3xl font-bold mb-1">{pendingPaymentBookings}</div>
          <div className="text-sm opacity-90">Chờ thanh toán</div>
        </div>
      </div>
